...
class OAIEmbedding(OAI):
    def __init__(self, temperature=0, top_p=0.95):
        super().__init__()
    ...
    def generate(self, text: str) -> List[float]:
        return (
            self.client.embeddings.create(
                ...
                temperature=self.temperature,  # Use temperature here if applicable
                top_p=self.top_p  # Use top_p here if applicable
            )
            .data[0]
            .embedding
        )
